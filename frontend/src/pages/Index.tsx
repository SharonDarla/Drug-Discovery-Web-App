...
import { Separator } from '@/components/ui/separator';
import { useToast } from '@/components/ui/use-toast';
import { ArrowRight, Beaker, Microscope, FlaskConical, ArrowDownToLine, RotateCcw, Sun, Moon } from 'lucide-react';
import Molecule, { MoleculeData } from '@/components/Molecule';
import TrendCard from '@/components/TrendCard';
      ...
      <div className="container px-4 py-8 mx-auto max-w-7xl">
        ...
        <div className="flex justify-end mb-4 animate-fadeIn">
          <Button
            ...
            className="w-10 h-10 rounded-full bg-white/80 dark:bg-slate-900/80 backdrop-blur-sm border-slate-200 dark:border-slate-800 shadow-sm hover:shadow transition-all duration-200 hover:scale-105"
            title="Toggle theme"
          >
            {theme === 'light' ? (
